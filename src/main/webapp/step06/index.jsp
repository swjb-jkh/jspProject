      ...
      <%@ page import="dto.Product" %>
        <%-- <%@ page import="dao.ProductRepository" %> --%>
          <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <% String edit=request.getParameter("edit"); if (edit==null) edit="" ; %>
              <!DOCTYPE html>
              <html lang="en">
                    ...
                    <main class="main">
                      ...
                      <%@ include file="dbconn.jsp" %>
                        ...
                        <section id="products" class="portfolio section">
                          ...
                          <%-- <% ProductRepository dao=productDAO.getInstance(); ArrayList<Product> listOfProducts =
                            dao.getAllProducts();
                            %> --%>
                                      ...
                                      <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                                        <div class="portfolio-content h-100">
                                          ...
                                          <div class="portfolio-info">
                                            ...
                                            <br />
                                            <p>
                                              <a href="./product.jsp?id=<%=rs.getString(" p_productId")%>" class="btn
                                                btn-secondary">상세 정보 바로가기 &raquo;</a>
                                              <% if(edit.equals("update")){ %>
                                                <a href="./editProduct.jsp?id=<%=rs.getString(" p_productId")%>"
                                  ...
                                  <div class="testimonial-item">
                                    ...
                                    <p>
                                      ...
                                      <span>Fugiat enim eram quae cillum dolore dolor amet nulla culpa multos export
                                        minim fugiat minim velit minim dolor enim duis veniam ipsum anim magna sunt elit
                                        fore quem dolore labore illum veniam.</span>
                                      <i class="bi bi-quote quote-icon-right"></i>
                                    </p>
                                  </div>
                                </div><!-- End testimonial item -->
