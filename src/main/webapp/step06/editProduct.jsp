					...
					<form class="g-3" action="./processUpdateProduct.jsp" method="post" enctype="multipart/form-data" name="registerNewProduct">
						<div class="row m-3">
							...
							<div class="col-4">
								...
								placeholder="" name="newProduct" value="<%= rs.getString("p_productId")%>">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-2">
							...
							<div class="col-4">
								<input type="text" class="form-control" id="pName"
									placeholder="" name="pName" value="<%= rs.getString("p_pname")%>">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-2">
							...
							<div class="col-4">
								...
								placeholder="" name="unitPrice" value="<%= rs.getString("p_unitPrice")%>">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-2">
							...
							<div class="col-4">
								...
								placeholder="" name="description" value="<%= rs.getString("p_description")%>">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-2">
							...
							<div class="col-4">
								<input type="text" class="form-control" id="category"
									placeholder="" name="category" value="<%= rs.getString("p_category")%>">
							</div>
						</div>
						<div class="row m-3">
							<div class="col-2">
